...
Step	Description
1️⃣	Removed rows where mrp or discountedSellingPrice is zero (invalid pricing).
2️⃣	Converted prices from paise to rupees (i.e., divided by 100) for accurate monetary representation.
3️⃣	Checked for NULL values across all columns – none found in the cleaned dataset.
4️⃣	Identified duplicate product names to review potential data entry issues.
📊 Business Questions & Analysis (20 Queries)
